...
import com.urjc.mca.tema12.p2.feign.NotificationClient;
...
public class CustomerService {
    ...
    @Value("${notification.service.microservices}")
    private boolean notificacionMicroservices;
    ...
    private void sendNotification(long id, int quantity) {
        ...
        if (notificacionMicroservices) {
            Map<String, String> notification = new HashMap<>();
            notification.put("customer", ""+id);
